...
bazel build `-s `-`-experimental_execution_log_file ${ARTIFACT_DIRS}/build_execution_windows.log //...

bazel shutdown

bazel test `-s `-`-experimental_execution_log_file ${ARTIFACT_DIRS}/test_execution_windows.log //...
