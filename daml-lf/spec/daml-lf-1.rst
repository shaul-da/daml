...
Then we can define our kinds, types, and expressions::
  ...
  Types (mnemonic: tau for type)
    τ, σ
      ::= α                                         -- TyVar: Type variable
       ...
       |  ∀ α : k . Eq α ⇒ τ                        -- TyEqForall: Constrained Universal quantification
  ...
  Expressions
    e ::= x                                         -- ExpVar: Local variable
       ...
       |  Λ α : k . Eq α ⇒ e                        -- ExpTyAbs: Constrained Type abstraction
...
The we defined *valid type constraint*. ::
 ...
 Constraint Context     
  ...
  ——————————————————————————————————————————————————————————————— EqTuple
   ...
   ——————————————————————————————————————————————————————————————— EqRecord
    ...
    K ⊢ Eq τ₁  …  K ⊢ Eq τₘ
    'variant' T (α₁:k₁) … (αₙ:kₙ) ↦  V₁:τ₁ |  … | Vₘ:τₘ   ∈ 〚Ξ〛Mod
    K · Eq α₁ ⋯ · Eq αₙ ⊢ Eq τ₁
      ⋮
    K · Eq α₁ ⋯ · Eq αₙ ⊢ Eq τₘ 
   ——————————————————————————————————————————————————————————————— EqVariant
...
Then we define *well-formed expressions*. ::
  ...
  Well-formed expressions │ Γ, K ⊢  e  :  τ │
    ...
    ——————————————————————————————————————————————————————————————— ExpTyAbs
      ...
      α : k · Γ, Eq α · K  ⊢  e  :  τ
    ——————————————————————————————————————————————————————————————— ExpTyAbs
      Γ , K ⊢  Λ α : k . e  :  ∀ α : k . Eq α ⇒ τ
           
      Γ , K  ⊢  e₁  :  τ      Γ  ⊢  τ  :  ⋆
      x : τ · Γ , K  ⊢  e₂  :  σ
    ——————————————————————————————————————————————————————————————— ExpLet
      Γ , K  ⊢  'let' x : τ = e₁ 'in' e₂  :  σ
    ...
    ——————————————————————————————————————————————————————————————— ExpListNil
      ...
      Γ  ⊢  τ  :  ⋆
      Γ , K  ⊢  eₕ  :  τ     Γ , K  ⊢  eₜ  :  'List' τ
    ——————————————————————————————————————————————————————————————— ExpListCons
      Γ , K  ⊢  'Cons' @τ eₕ eₜ  :  'List' τ
     ...
     —————————————————————————————————————————————————————————————— ExpOptionNone
      ...
      Γ  ⊢  τ  :  ⋆     Γ , K  ⊢  e  :  τ
    ——————————————————————————————————————————————————————————————— ExpOptionSome
      Γ , K  ⊢  'Some' @τ e  :  'Option' τ

      'tpl' (x : T) ↦ …  ∈  〚Ξ〛Mod       Γ , K  ⊢  e  : Mod:T
    ——————————————————————————————————————————————————————————————— ExpToAnyTemplate
      Γ , K  ⊢  'to_any_template' @Mod:T e  :  'AnyTemplate'

      'tpl' (x : T) ↦ …  ∈  〚Ξ〛Mod
       Γ , K  ⊢  e  : AnyTemplate
    ——————————————————————————————————————————————————————————————— ExpFromAnyTemplate
      Γ , K  ⊢  'from_any_template' @Mod:T e  :  'Optional' Mod:T
    ...
    ———————————————————————————————————————————————————————————————— ExpRecCon
      ...
      Γ , K  ⊢  e  :  Mod:T τ₁ … τₙ
    ——————————————————————————————————————————————————————————————— ExpRecProj
      Γ , K  ⊢  Mod:T @τ₁ … @τₙ {f} e  :  σ[α₁ ↦ τ₁, …, αₙ ↦ τₙ]
    ...
    ———————————————————————————————————————————————————————————————– ExpRecUpdate
      ...
      Γ , K  ⊢  e  :  σᵢ[α₁ ↦ τ₁, …, αₙ ↦ τₙ]
    ——————————————————————————————————————————————————————————————— ExpVarCon
      Γ , K  ⊢  Mod:T:Vᵢ @τ₁ … @τₙ e  :  Mod:T τ₁ … τₙ
    ...
    ——————————————————————————————————————————————————————————————— ExpEnumCon
      ...
      Γ , K  ⊢  e₁  :  τ₁      …      Γ , K  ⊢  eₘ  :  τₘ
    ——————————————————————————————————————————————————————————————— ExpTupleCon
      Γ , K  ⊢  ⟨ f₁ = e₁, …, fₘ = eₘ ⟩  :  ⟨ f₁: τ₁, …, fₘ: τₘ ⟩

      Γ , K  ⊢  e  :  ⟨ …, fᵢ: τᵢ, … ⟩
    ——————————————————————————————————————————————————————————————— ExpTupleProj
      Γ , K  ⊢  e.fᵢ  :  τᵢ

      Γ , K  ⊢  e  :  ⟨ f₁: τ₁, …, fᵢ: τᵢ, …, fₙ: τₙ ⟩
      Γ , K  ⊢  eᵢ  :  τᵢ
    ——————————————————————————————————————————————————————————————— ExpTupleUpdate
      Γ , K  ⊢   ⟨ e 'with' fᵢ = eᵢ ⟩  :  ⟨ f₁: τ₁, …, fₙ: τₙ ⟩

      'variant' T (α₁:k₁) … (αₙ:kn) ↦ … | V : τ | …  ∈  〚Ξ〛Mod
      Γ , K  ⊢  e₁  :  Mod:T τ₁ … τₙ
      x : τ[α₁ ↦ τ₁, …, αₙ ↦ τₙ] · Γ , K  ⊢  e₂  :  σ
    ——————————————————————————————————————————————————————————————— ExpCaseVariant
      Γ , K  ⊢  'case' e₁ 'of' Mod:T:V x → e₂ : σ

      'enum' T ↦ … | E | …  ∈  〚Ξ〛Mod
      Γ , K  ⊢  e₁  :  Mod:T
      Γ , K  ⊢  e₂  :  σ
    ——————————————————————————————————————————————————————————————— ExpCaseEnum
      Γ , K  ⊢  'case' e₁ 'of' Mod:T:E → e₂ : σ

      Γ , K  ⊢  e₁  : 'List' τ      Γ , K  ⊢  e₂  :  σ
    ——————————————————————————————————————————————————————————————— ExpCaseNil
      Γ , K  ⊢  'case' e₁ 'of' 'Nil' → e₂ : σ

      xₕ ≠ xₜ
      Γ , K  ⊢  e₁  : 'List' τ
      Γ , K  ⊢  xₕ : τ · xₜ : 'List' τ · Γ , K  ⊢  e₂  :  σ
    ——————————————————————————————————————————————————————————————— ExpCaseCons
      Γ , K  ⊢  'case' e₁ 'of' Cons xₕ xₜ → e₂  :  σ

      Γ , K  ⊢  e₁  : 'Option' τ      Γ , K  ⊢  e₂  :  σ
    ——————————————————————————————————————————————————————————————— ExpCaseNone
      Γ , K  ⊢  'case' e₁ 'of' 'None' → e₂ : σ

      Γ , K  ⊢  e₁  : 'Option' τ      x : τ · Γ , K  ⊢  e₂  :  σ
    ——————————————————————————————————————————————————————————————— ExpCaseSome
      Γ , K  ⊢  'case' e₁ 'of' 'Some' x → e₂  :  σ

      Γ , K  ⊢  e₁  :  'Bool'       Γ , K  ⊢  e₂  :  σ
    ——————————————————————————————————————————————————————————————— ExpCaseTrue
      Γ , K  ⊢  'case' e₁ 'of 'True' → e₂  :  σ

      Γ , K  ⊢  e₁  :  'Bool'       Γ , K  ⊢  e₂  :  σ
    ——————————————————————————————————————————————————————————————— ExpCaseFalse
      Γ , K  ⊢  'case' e₁ 'of 'False' → e₂  :  σ
    ...
    ——————————————————————————————————————————————————————————————— ExpCaseDefault
      ...
      Γ , K  ⊢  'case' e 'of' alt₁ : σ
        ⋮
      Γ , K  ⊢  'case' e 'of' altₙ : σ
    ——————————————————————————————————————————————————————————————— ExpCaseOr
      Γ , K  ⊢  'case' e 'of' alt₁ | … | altₙ : σ
    ...
    ——————————————————————————————————————————————————————————————— UpdPure
      ...
      Γ  ⊢  τ₁  : ⋆       Γ , K  ⊢  e₁  :  'Update' τ₁
      Γ , K  ⊢  x₁ : τ₁ · Γ , K  ⊢  e₂  :  'Update' τ₂
    ——————————————————————————————————————————————————————————————— UpdBlock
      Γ , K  ⊢  'bind' x₁ : τ₁ ← e₁ 'in' e₂  :  'Update' τ₂

      'tpl' (x : T) ↦ …  ∈  〚Ξ〛Mod       Γ , K  ⊢  e  : Mod:T
    ——————————————————————————————————————————————————————————————— UpdCreate
      Γ , K  ⊢  'create' @Mod:T e  : 'Update' ('ContractId' Mod:T)

      'tpl' (x : T)
          ↦ { …, 'choices' { …, 'choice' ChKind Ch (y : τ) (z : 'ContractId' Mod:T) : σ 'by' … ↦ …, … } }
        ∈ 〚Ξ〛Mod
      Γ , K  ⊢  e₁  :  'ContractId' Mod:T
      Γ , K  ⊢  e₂  :  'List' 'Party'
      Γ , K  ⊢  e₃  :  τ
    ——————————————————————————————————————————————————————————————— UpdExercise
      Γ , K  ⊢  'exercise' @Mod:T Ch e₁ e₂ e₃  : 'Update' σ
    ...
    ——————————————————————————————————————————————————————————————— UpdExerciseWithouActors
      Γ , K  ⊢  'exercise_without_actors' @Mod:T Ch e₁ e₂  : 'Update' σ

      'tpl' (x : T) ↦ …  ∈  〚Ξ〛Mod
      Γ , K  ⊢  e₁  :  'ContractId' Mod:T
    ——————————————————————————————————————————————————————————————— UpdFetch
      Γ , K  ⊢  'fetch' @Mod:T e₁ : 'Update' Mod:T

    ——————————————————————————————————————————————————————————————— UpdGetTime
      Γ , K  ⊢  'get_time'  : 'Update' 'Timestamp'

      'tpl' (x : T)  ↦ { …, 'key' τ …, … } ∈ 〚Ξ〛Mod
      Γ , K  ⊢  e : τ
    ——————————————————————————————————————————————————————————————— UpdFetchByKey
      Γ , K  ⊢  'fetch_by_key' @Mod:T e
              :
        'Update' ⟨
      ...
      Γ , K  ⊢  e : τ
    ——————————————————————————————————————————————————————————————— UpdLookupByKey
      Γ , K  ⊢  'lookup_by_key' @Mod:T e
              :
	    'Update' ('Option' (ContractId Mod:T))

      Γ , K  ⊢  e  :  'Update' τ
    ——————————————————————————————————————————————————————————————— UpdEmbedExpr
      Γ , K  ⊢  'embed_expr' @τ e  :  Update' τ
